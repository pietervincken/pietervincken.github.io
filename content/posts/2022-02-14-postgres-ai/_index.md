...
This post was originally posted on the [Ordina JWorks Blog](https://blog.ordina-jworks.io/cloud/2022/02/14/postgres-ai.html)
...
It has been created by Postgres.ai which was founded by [Nikolay Samokhvalov](https://twitter.com/samokhvalov).
...
The magic is mostly done by the use of a [ZFS](https://en.wikipedia.org/wiki/ZFS) filesystem underneath the PostgreSQL instances used by DLE. 
...
This phase is called the logical dump in the [DLE documentation](https://postgres.ai/docs/reference-guides/database-lab-engine-configuration-reference#job-logicaldump).
This dump is `restored` onto a local PostgreSQL install and from there clone could be created. 
This is called the logical restore phase in the [documentation](https://postgres.ai/docs/reference-guides/database-lab-engine-configuration-reference#job-logicalrestore).
...
This last phase is called [logical snapshot](https://postgres.ai/docs/reference-guides/database-lab-engine-configuration-reference#job-logicalsnapshot).
...
All code for the example is available [here](https://github.com/pietervincken/dblab-azure-demo)
...
![Dashboard](images/clones-dashboard.png)

![Instance status](images/instance-status.png)
...
![Create clone](images/create-clone.png)
...
![Reset clone](images/reset-clone.png)
...
A very helpful feature is their support for [data masking and obfuscation](https://postgres.ai/docs/database-lab/masking).
...
Another option that DLE support is using [PostgreSQL Anonymizer](https://postgresql-anonymizer.readthedocs.io/en/stable/static_masking.html). 
...
If you want a more in-depth post about how to configure DLE and which pitfalls we found, let me know on [LinkedIn!](https://www.linkedin.com/in/pieter-vincken-a94b5153/)
...
Feel free to reach out to [me](https://www.linkedin.com/in/pieter-vincken-a94b5153/) or directly to lovely people of [Postgres.ai](https://postgres.ai/) if you want to look into this solution. 
