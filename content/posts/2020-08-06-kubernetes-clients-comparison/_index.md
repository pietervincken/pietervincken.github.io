--- 
authors: ["Pieter Vincken", "Yolan Vloeberghs"]
title: "Kubernetes clients and dashboards: a comparison"
description: ""
date: 2020-08-06T09:00:00+01:00
slug: ""
...
This post was originally posted on the [Ordina JWorks Blog](https://blog.ordina-jworks.io/cloud/2020/08/28/kubernetes-clients-comparison.html)
...
[K9s](https://github.com/derailed/k9s) is a Kubernetes client built by [Fernand Galiana](https://twitter.com/kitesurfer).
...
![k9s from deployment to pod logs](images/k9s-deploy.gif)

Demo: Switch between two Kubernetes contexts
![k9s context switch](images/k9s-ctx.gif)

Demo: Find out where a configmap is used
![k9s config map usage](images/k9s-cm.gif)

## Octant
[Octant](https://github.com/vmware-tanzu/octant) is an open-source Kubernetes web dashboard built by VMWare Tanzu.
...
![Octant port forwarding](images/octant-pf.gif)
...
For example, there is a [Helm plugin](https://github.com/bloodorangeio/octant-helm) available and Jenkins X has a repository of Octant [plugins](https://github.com/jenkins-x/octant-jx).
...
Octant slideshow
![Octant slideshow](images/octant.gif)

## Lens

[Lens app](https://github.com/lensapp/lens) is a Kubernetes client with a proper GUI.
...
In those cases, you can just [add some configuration](https://github.com/lensapp/lens/blob/master/troubleshooting/custom-prometheus.md) to that instance and point the Lens app to that Prometheus instance.
...
![Lens pod list](images/lens-pod-list.png)

Screenshot: Details about a pod in Lens, including Prometheus supplied metrics
![Lens pod details](images/lens-pod-details.png)

Screenshot: Overview of a cluster in Lens, including the last error events
![Lens cluster overview](images/lens-cluster-overview.png)

## Kubenav
[Kubenav](https://github.com/kubenav/kubenav) is a rich featured, open source Kubernetes client created in early 2020 to manage your cluster(s) with. 
...
Kubenav slideshow
![Kubenav slideshow](images/kubenav.gif)

## Infra App
[Infra App](https://infra.app/) is a new addition to the list of Kubernetes clients.
It is made by the people over at Docker Desktop & [Kitematic](https://kitematic.com) and is being developed behind closed doors, which has been addressed as "unpleasant" within the Kubernetes community.
...
![Infra App slideshow](images/infra-app.gif)
...
The [plugins](https://github.com/topics/octant-plugin) add a lot of value to the tool and might make it a very compelling option for your use-case.
