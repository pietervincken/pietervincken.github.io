...
This post was originally posted on the [Ordina JWorks Blog](https://blog.ordina-jworks.io/cloud/2022/10/27/renovate.html)
...
[Mend Renovate](https://www.mend.io/free-developer-tools/renovate/) (formerly known as WhiteSource Renovate) is a tool that detects dependencies in your code and informs you about new versions of your dependencies.
...
As of time of writing, Renovate supports about [80 different dependency management](https://docs.renovatebot.com/modules/manager/) systems out of the box.
...
![PR with changelogs](images/pr-changelog.png)
...
If you're using GitHub, the setup is as easy as enabling the [GitHub Renovate app](https://github.com/apps/renovate) for your repository. 
...
You can run Renovate [as (part of) a pipeline](https://docs.renovatebot.com/examples/self-hosting/#gitlab-cicd-pipeline), as a [Docker container](https://docs.renovatebot.com/examples/self-hosting/#docker) or even as a [CronJob on Kubernetes](https://docs.renovatebot.com/examples/self-hosting/#kubernetes).
Since you only need NodeJS/NPM to be available, you can run it almost anywhere you want. 
You can find an example of how to run Renovate as a Cronjob on a Kubernetes cluster in [this repository](https://github.com/pietervincken/renovate-tekton-argo-talk/tree/main/k8s/renovate).
...
To prevent you and/or your developers from becoming overwhelmed by this, [limiting the concurrent pull requests](https://docs.renovatebot.com/configuration-options/#prconcurrentlimit) is a must!
...
![Kubernetes API updates](images/k8s-api-update.jpg)
...
- [JOIN 2022 Talk YouTube Link](https://youtu.be/fAEbRmD4-G0)
- [Sample Renovate Setup](https://github.com/pietervincken/renovate-tekton-argo-talk/tree/main/k8s/renovate)

This blog post is a companion to a talk at the JOIN 2022 conference.

Feel free to reach out to [me](https://www.linkedin.com/in/pieter-vincken-a94b5153/) if you want to look into this solution. 
