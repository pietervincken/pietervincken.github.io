...
This post was originally posted on the [Ordina JWorks Blog](https://blog.ordina-jworks.io/cloud/2023/10/20/k8s-comparison-azure-aws.html)
...
- Buy before build, prioritize Free Open Source Software (FOSS) from the Cloud-Native Computing Foundation ([CNCF](https://www.cncf.io/)) over Commercial Off The Shelf (COTS) solutions.
...
This setup can be reviewed in the demo repositories for this blog post: [Azure](https://github.com/pietervincken/k8s-on-azure), (AWS)[https://github.com/pietervincken/k8s-on-aws] and (common)[https://github.com/pietervincken/renovate-tekton-argo-talk]
...
For EKS, an option can be enabled by [providing a Key Management Service (KMS) Key](https://docs.aws.amazon.com/eks/latest/userguide/enable-kms.html).
...
- [Node patch management without nodepool upgrades](https://docs.aws.amazon.com/eks/latest/userguide/update-managed-node-group.html)
...
If you have any other topics you'd like to see discussed, you want help with your own Kubernetes journey or you have feedback about this blog post, feel free to contact [Pieter](https://be.linkedin.com/in/pieter-vincken-a94b5153) on LinkedIn!