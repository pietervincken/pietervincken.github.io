---
authors: ["Pieter Vincken", "Yannick Bontemps"]
title: "Back to Terraform"
description: ""
date: 2023-06-05T09:00:00+01:00
slug: ""
tags: ["cloud", "automation", "cicd", "terraform", "iac", "aws"]
categories: ["Cloud"]
series: []
cover:
...
This post was originally posted on the [Ordina JWorks Blog](https://blog.ordina-jworks.io/cloud/2023/06/05/back-to-terraform.html)
...
The support for reviewing the changes that Pulumi will make is limited to the CLI and saving a `change plan` that can be reviewed is supported, [but behind an experimental flag](https://www.pulumi.com/docs/intro/concepts/update-plans/), which suggests it's not ready for production use. 
...
The cross-language component support is also a feature that's [still under heavy development](https://github.com/pulumi/pulumi/issues/6804) and cannot be used properly at the time of writing. 
...
There is [support for testing](https://www.pulumi.com/docs/guides/testing/) in Pulumi, but due to the lack of `real` mocking capabilities (including any side-effects) in Pulumi, the tests feel like testing getters and setters instead of proper tests. 
...
Pulumi and TerraGrunt might pop up on our horizon in the future again, but for now, we'll stick with good old ([28 July 2014](https://en.wikipedia.org/wiki/Terraform_(software))) Terraform. 

If you want help with your Infrastructure As Code, cloud adoption in your company or want to provide feedback, feel free to contact [Yannick](https://be.linkedin.com/in/yannick-bontemps-885379b0) or [Pieter](https://be.linkedin.com/in/pieter-vincken-a94b5153) on LinkedIn!