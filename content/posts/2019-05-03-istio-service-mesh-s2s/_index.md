...
This post was originally posted on the [Ordina JWorks Blog](https://blog.ordina-jworks.io/cloud/2019/05/03/istio-service-mesh-s2s.html)
...
More information on Istio and its features can be found in its [docs](https://istio.io/docs/).
...
![Istio architecture drawing](images/arch.svg)
...
[Destination rules](https://istio.io/docs/concepts/traffic-management/#destination-rules) are a set of rules that are evaluated when a service is called.
...
The full examples can be found in the accompanying repository on [Github](https://github.com/pietervincken/istio-service-to-service-demo)

### Prerequisites

This demo assumes that Istio is already installed in the cluster with the demo profile enabled. 
See [Install Istio](https://istio.io/docs/setup/kubernetes/install/helm/#option-1-install-with-helm-via-helm-template) for more information on the installation of Istio.
In the demo repository, a small [script](https://github.com/pietervincken/istio-service-to-service-demo/blob/master/1-install-istio.sh) can be found that can assist in setting up the demo environment
...
More information on the probes can be found in the [Istio Docs](https://istio.io/help/ops/setup/app-health-check/#probe-rewrite).
...
![Basic setup in Istio](images/istio-basic-setup.png)
...
![Broken mTLS drawing](images/istio-mtls-broken.png)
...
![RBAC refuses connection](images/istio-rbac-refused.png)
